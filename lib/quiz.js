...
// ask a question in terminal - works inside git hooks on Windows
...
export async function runQuiz(files) {
  ...
  for (const filePath of files) {
    ...
    // get answer using readline instead of inquirer
    let answer;
    try {
        answer = await askQuestion(chalk.yellow("  Your answer: "));
    } catch {
